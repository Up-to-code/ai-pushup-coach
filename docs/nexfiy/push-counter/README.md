...
- Better Auth requires `EXPO_PUBLIC_CONVEX_SITE_URL` in the Expo environment and `BETTER_AUTH_SECRET`, `SITE_URL`, `APPLE_CLIENT_ID`, `APPLE_CLIENT_SECRET`, and optional `APPLE_APP_BUNDLE_IDENTIFIER` in the Convex environment.
