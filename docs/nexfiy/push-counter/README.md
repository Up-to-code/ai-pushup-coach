...
- Add links on the page for Privacy Policy, Terms of Use, Support, and Apple Legal.
...
- Confirm production Better Auth, Convex, Adapty, and UploadThing credentials before archive.
- Better Auth requires `EXPO_PUBLIC_CONVEX_SITE_URL` in the Expo environment and `BETTER_AUTH_SECRET`, `SITE_URL`, `APPLE_CLIENT_ID`, `APPLE_CLIENT_SECRET`, `APPLE_APP_BUNDLE_IDENTIFIER=com.aipushupcoach.app`, `GOOGLE_CLIENT_ID`, and `GOOGLE_CLIENT_SECRET` in the Convex environment.
