...
- `website-format-notes.md`: Implementation notes for converting the Markdown content into the Nexfiy website format.
- `assets/`: Copied app icons, logo, favicon, and app visuals.
...
This bundle describes the current Push Counter app behavior:

- Four-week push-up plans.
- Camera-assisted push-up rep counting on supported devices.
- Manual-friendly fallback when camera access is denied or unavailable.
...
Do not publish unsupported claims. Push Counter is fitness guidance, not medical advice. The app should not claim guaranteed results, medical treatment, saved workout videos, or Android availability before those are true.
