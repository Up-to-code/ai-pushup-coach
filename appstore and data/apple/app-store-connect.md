# Push Counter App Store Connect Metadata

## App Information

- App name: Push Counter
- Recommended product title: Push Counter: Push-Up Tracker
- Bundle ID: use the active Apple Developer bundle identifier configured for the submitted build.
...
Keywords, 100-character version:
...
- Ensure the paywall shows product, billed price and billing period as the primary purchase element, with yearly 3-day free trial terms, renewal behavior, Privacy Policy link, and Terms of Use link in subordinate text before purchase.
